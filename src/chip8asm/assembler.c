...
inline void assRet(void) { emit(0x00EE); }
...
Clear the display.
*/
inline void assCls(void) { emit(0x00E0); }
...
inline void assHigh(void) { emit(0x00FF); }
...
inline void assAudio(void) { emit(0xF002); }
